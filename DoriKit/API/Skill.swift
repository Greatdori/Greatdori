...
extension DoriAPI.Skill {
    ...
    public struct Skill: Sendable, Identifiable, Equatable, Hashable, Codable, DoriCache.Cacheable {
        ...
        public struct ActivationEffect: Sendable, Equatable, Hashable, Codable, DoriCache.Cacheable {
            ...
            public enum ActivateConditionType: String, Sendable, Hashable, Codable, DoriCache.Cacheable {
                case pure = "PURE"
                case cool = "COOL"
                case happy = "HAPPY"
            ...
            public enum ActivateEffectType: String, Sendable, Hashable, Codable, DoriCache.Cacheable {
                case score
                case judge
            ...
            public struct ActivateEffect: Sendable, Equatable, Hashable, Codable, DoriCache.Cacheable {
                ...
                public enum ValueType: String, Sendable, Hashable, Codable, DoriCache.Cacheable {
                    case rate
                    case realValue = "real_value"
                }
                public enum ActivateCondition: String, Sendable, Hashable, Codable, DoriCache.Cacheable {
                    case none
                    case good
                    case perfect
                }
        ...
        public struct OnceEffect: Sendable, Equatable, Hashable, Codable, DoriCache.Cacheable {
            ...
            public enum OnceEffectType: String, Sendable, Hashable, Codable, DoriCache.Cacheable {
                case life
            }
            public enum ValueType: String, Sendable, Hashable, Codable, DoriCache.Cacheable {
                case realValue = "real_value"
            }
            public enum ConditionLifeType: String, Sendable, Hashable, Codable, DoriCache.Cacheable {
